/*
	...
	Assignment 6: (Extra Credit) Priority Queue of Documents
*/
...
TRAFFIC RUNNING...
Enter Q to quit
From intersection  <enter column from A to D>: A
<enter row from 1 to 4>: 1
From A1 to intersection  <enter column from A to D>: B
<enter row from 1 to 4>: 2
B2
...
Iterations = 6
The following itinerary is suggested:
A1 - A2 - B2
Number of edges required: 2

Enter Q to quit
From intersection  <enter column from A to D>: D
<enter row from 1 to 4>: 4
From D4 to intersection  <enter column from A to D>: A
<enter row from 1 to 4>: 3
A3
...
The following itinerary is suggested:
D4 - D3 - D2 - C2 - A2 - A3
Number of edges required: 5

Enter Q to quit
From intersection  <enter column from A to D>:
*/